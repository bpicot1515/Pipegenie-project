# pipegenie/classification/pipegenie_classifier.py
...
class PipegenieClassifier(BaseClassificationRegression):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            metalearning_seeding_strategy=metalearning_seeding_strategy,
            # --------------------
    ...
    def fit(self, X: 'ArrayLike', y: 'ArrayLike', **kwargs) -> 'PipegenieClassifier':
        """
